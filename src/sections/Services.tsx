...
export default function Services() {
  return (
    <SectionWrapper id="services" className="py-16 sm:py-24 max-w-4xl mx-auto">
      <h2 className="text-3xl font-bold mb-10 text-center text-green-700 dark:text-green-400">Services</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-8">
        {SERVICES.map((service) => (
          <div key={service.title} className="flex flex-col items-center bg-white/80 dark:bg-zinc-900/80 rounded-2xl shadow-lg p-5 sm:p-8 group hover:shadow-2xl transition-shadow">
